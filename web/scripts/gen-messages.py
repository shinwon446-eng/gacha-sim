...
UI = {
  "ko": {
    ...
    "unbox": {
      ...
      "verify": "이 결과 검증", "close": "닫기", "keep": "보관함으로", "kept": "보관함에 저장됐습니다 — 팝업을 닫아도 유지됩니다",
  ...
  "en": {
    ...
    "unbox": {
      ...
      "verify": "Verify this result", "close": "Close", "keep": "Keep in inventory", "kept": "Saved to your vault — it stays after you close this",
  ...
  "zh": {
    ...
    "unbox": {
      ...
      "verify": "验证本次结果", "close": "关闭", "keep": "存入仓库", "kept": "已存入仓库 — 关闭后仍会保留",
